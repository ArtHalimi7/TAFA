  ...
  const features = [
    {
      ...
      description: 'Every vehicle undergoes our comprehensive 200-point inspection protocol. We verify authenticity, mechanical excellence, and pristine condition.'
    },
    {
      number: '02',
      icon: (
      ...
      description: 'Every car is dynamically tested to ensure peak performance. From acceleration to handling, we guarantee perfection.'
    },
    {
      number: '03',
      icon: (
      ...
      description: 'Complete history documentation. Service records, ownership transfers, and authenticity certificates included with every purchase.'
    },
    {
      number: '04',
      icon: (
      ...
      description: 'Transparent pricing based on market data, condition, and rarity. No hidden markups or surprise fees.'
    },
    {
      number: '05',
      icon: (
      ...
      description: 'Ownership never ends with us. Concierge service, maintenance guidance, and expert advice available 24/7.'
    },
    {
      number: '06',
      icon: (
      ...
      description: 'Custom solutions including financing, insurance coordination, and specialized delivery options.'
    },
  ]
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div 
          className={`absolute -top-1/4 -right-1/4 w-[800px] h-[800px] rounded-full bg-black/[0.02] blur-3xl transition-all duration-[2s] ${
            isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-50'
          }`}
        />
        <div 
          className={`absolute -bottom-1/4 -left-1/4 w-[600px] h-[600px] rounded-full bg-black/[0.01] blur-3xl transition-all duration-[2s] delay-300 ${
            isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-50'
          }`}
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
        ...
        <div className="max-w-3xl mb-20 lg:mb-32">
          ...
          >
            In a world of dealerships, we stand apart. Our commitment to excellence means every detail matters, from curation to clientele.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="h-full flex flex-col p-8 lg:p-10 border border-black/20 hover:border-black/40 hover:bg-black/5 transition-all duration-500 rounded-lg">
                {/* Top accent */}
                <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                ...
                {/* Description */}
                <p 
                  className="text-black/75 leading-relaxed flex-grow group-hover:text-black/90 transition-colors duration-300"
                  style={{ fontFamily: 'Montserrat, sans-serif' }}
                >
                  {feature.description}
                </p>
        ...
        >
          ...
          >
            ...
            <span className="block font-bold mt-4">It's about joining a legacy of excellence.</span>
          </p>
