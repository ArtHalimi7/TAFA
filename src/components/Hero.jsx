        ...
        <div className="flex flex-col justify-center items-center lg:items-start text-center lg:text-left px-6 sm:px-12 lg:pl-32 xl:pl-40 w-full lg:w-1/2">
          ...
          >
            <span 
              ...
              style={{ fontFamily: 'Cera Pro, sans-serif', fontWeight: '900', letterSpacing: '-0.03em' }}
            >
              AUTO TAFA
            </span>
          </h1>
          ...
          <p 
            ...
            style={{ fontFamily: 'Montserrat, sans-serif', letterSpacing: '0.02em', transitionDelay: '0.2s' }}
          >
          ...
          <div className="lg:hidden mt-24 w-full">
            <div className={`flex flex-wrap justify-center gap-6 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '0.4s' }}>
              {[
