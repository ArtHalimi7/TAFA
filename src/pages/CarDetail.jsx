...
const carsData = {
  'mercedes-amg-gt-63-s': {
    ...
    description: 'This Mercedes-AMG GT 63 S represents the pinnacle of automotive engineering. Hand-built by AMG craftsmen in Affalterbach, Germany, this four-door coupe delivers breathtaking performance while maintaining the luxury and refinement expected from the Mercedes-Benz marque.'
  },
  'bmw-m760i-xdrive': {
    id: 2,
    ...
    description: 'The BMW M760i xDrive is the flagship of the 7 Series lineup, combining the silky smoothness of a V12 engine with the latest in luxury technology and comfort features.'
  },
  'audi-rs-etron-gt': {
    id: 3,
    ...
    description: 'The Audi RS e-tron GT represents the future of high-performance motoring. With instant torque delivery and Audi\'s legendary quattro system, this electric gran turismo delivers supercar performance with zero emissions.'
  }
};
...
export default function CarDetail() {
  ...
  const specs = [
    ...
    { label: '0-60 mph', value: car.acceleration, suffix: 's', isDecimal: true },
  ...
  return (
    <main className="min-h-screen bg-black text-white">
        ...
        <div className="relative h-screen overflow-hidden">
            ...
            {car.images.map((_, index) => (
              <button
                ...
                className={`relative w-12 h-1 rounded-full transition-all duration-300 overflow-hidden ${
                  activeImageIndex === index ? 'bg-white' : 'bg-white/30 hover:bg-white/50'
                }`}
              >
          ...
          <div className="absolute inset-0 flex items-center justify-center sm:justify-start p-6 sm:p-12 lg:p-24">
            <div className="w-full sm:max-w-7xl mx-auto text-center sm:text-left">
              ...
              >
                <span className="px-4 py-1.5 border border-white/30 rounded-full text-xs font-medium tracking-[0.2em] uppercase text-white/80"
              ...
              <h1 
                ...
                style={{ fontFamily: 'Cera Pro, sans-serif', letterSpacing: '-0.02em', transitionDelay: '0.3s' }}
              >
                {car.name}
              </h1>
              ...
              <p 
                ...
                style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 300, transitionDelay: '0.4s' }}
              >
                {car.tagline}
              </p>
              ...
              >
                <div className="flex flex-col">
                  <span className="text-3xl sm:text-4xl lg:text-5xl font-bold" style={{ fontFamily: 'Cera Pro, sans-serif' }}>
                    {car.year}
                  </span>
                  <span className="text-xs text-white/50 uppercase tracking-widest mt-1" style={{ fontFamily: 'Montserrat, sans-serif' }}>Year</span>
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-white/50 uppercase tracking-widest mt-1" style={{ fontFamily: 'Montserrat, sans-serif' }}>Miles</span>
                </div>
                <div className="w-px h-12 bg-white/20 hidden sm:block" />
                <div className="flex flex-col">
                  <span className="text-3xl sm:text-4xl lg:text-5xl font-bold" style={{ fontFamily: 'Cera Pro, sans-serif' }}>
                  ...
                  <span className="text-xs text-white/50 uppercase tracking-widest mt-1" style={{ fontFamily: 'Montserrat, sans-serif' }}>Price</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section ref={specsRef} className="relative py-20 lg:py-32 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
          ...
          <div className="mb-12 lg:mb-20">
            ...
            <p 
              className={`text-white/60 max-w-xl transition-all duration-1000 delay-100 ${
                specsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              Raw power meets refined engineering. Numbers that define excellence.
            </p>
          </div>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-baseline gap-1 mb-2">
                    ...
                    <span className="text-lg sm:text-xl text-white/50" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                      {spec.suffix}
                    </span>
                  </div>
                  <p className="text-xs sm:text-sm text-white/50 uppercase tracking-widest" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    {spec.label}
                  </p>
                </div>
          ...
          <div className="mt-16 lg:mt-24 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            >
              <h3 className="text-xl lg:text-2xl font-semibold" style={{ fontFamily: 'Cera Pro, sans-serif' }}>
                Powertrain
              </h3>
              <div className="space-y-4">
                {[
                  ...
                  >
                    <span className="text-white/50 text-sm uppercase tracking-wider" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                      {item.label}
                    </span>
                    <span className="text-white text-sm lg:text-base font-medium group-hover:translate-x-1 transition-transform duration-300" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                      {item.value}
                    </span>
                  </div>
                ))}
      ...
      <section ref={featuresRef} className="relative py-20 lg:py-32 bg-linear-to-b from-black via-neutral-950 to-black">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
          ...
          <div className="mb-12 lg:mb-20 text-center">
            ...
            <div 
              className={`w-16 h-1 bg-white mx-auto mb-6 transition-all duration-1000 delay-100 ${
                featuresVisible ? 'opacity-100 scale-x-100' : 'opacity-0 scale-x-0'
              }`}
              ...
              >
                <div className="flex items-center gap-3 w-full">
                  ...
                  <div className="shrink-0 w-5 h-5 rounded-full border border-white/30 flex items-center justify-center group-hover:border-white/60 group-hover:bg-white/10 transition-all duration-300">
                    <svg className="w-3 h-3 text-white/60 group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <span className="text-sm lg:text-base text-white/80 group-hover:text-white transition-colors duration-300" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    {feature}
                  </span>
                </div>
              </div>
          ...
          >
            <p className="text-lg lg:text-xl text-white/70 leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 300 }}>
              {car.description}
            </p>
          </div>
        </div>
      ...
      {/* Gallery Section */}
      <section ref={galleryRef} className="relative py-20 lg:py-32 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
          {/* Section Header */}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
            {car.images.map((image, index) => (
              ...
              >
                ...
                {/* Image Number */}
                <div className="absolute bottom-3 left-3 px-2 py-1 bg-black/60 backdrop-blur-sm rounded text-xs text-white/80 font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ fontFamily: 'Montserrat, sans-serif' }}>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="text-center lg:text-left">
              <p className="text-sm text-white/50 uppercase tracking-widest mb-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                Listed Price
              </p>
              <div className="flex items-baseline gap-2 justify-center lg:justify-start">
                <span className="text-5xl sm:text-6xl lg:text-7xl font-bold" style={{ fontFamily: 'Cera Pro, sans-serif' }}>
                  {formatPrice(car.price)}
                </span>
              </div>
              <p className="mt-4 text-white/50 text-sm" style={{ fontFamily: 'Montserrat, sans-serif' }}>
      ...
      {isGalleryOpen && (
        ...
        >
          ...
          <div className="flex items-center justify-between p-4 sm:p-6">
            ...
            >
              <span className="text-white font-medium">{modalImageIndex + 1}</span>
