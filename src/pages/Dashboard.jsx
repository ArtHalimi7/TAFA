...
const initialCarsData = [
  {
    ...
    showcaseImage: 0,
    features: ['AMG Carbon Fiber Trim', 'Burmester High-End 3D Surround', 'AMG Performance Exhaust'],
    description: 'This Mercedes-AMG GT 63 S represents the pinnacle of automotive engineering.',
    status: 'active',
  ...
  },
  {
    ...
    description: 'The Audi RS e-tron GT represents the future of high-performance motoring.',
    status: 'draft',
...
const categories = ['Performance', 'Luxury Sedan', 'Electric', 'SUV', 'Coupe', 'Convertible'];
const brands = ['Mercedes', 'BMW', 'Audi', 'Porsche', 'Ferrari', 'Lamborghini', 'Bentley', 'Rolls-Royce'];
...
export default function Dashboard() {
  ...
  const stats = {
    ...
    avgPrice: cars.length > 0 ? cars.reduce((sum, c) => sum + c.price, 0) / cars.length : 0
  };
  ...
  const removeImage = (index) => {
    ...
    const newShowcaseIndex = formData.showcaseImage >= newImages.length 
  ...
  const moveImage = (fromIndex, toIndex) => {
    ...
    } else if (fromIndex < formData.showcaseImage && toIndex >= formData.showcaseImage) {
      newShowcaseIndex--;
    } else if (fromIndex > formData.showcaseImage && toIndex <= formData.showcaseImage) {
      newShowcaseIndex++;
    }
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center px-6">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className={`absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-white/[0.02] blur-3xl transition-all duration-[2s] ${isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`} />
          <div className={`absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-white/[0.01] blur-3xl transition-all duration-[2s] delay-300 ${isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-50'}`} />
        </div>

        <div className={`relative z-10 w-full max-w-md transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {/* Logo */}
  ...
  return (
    <div className="min-h-screen bg-black text-white flex">
      ...
      <main className="flex-1 min-h-screen">
        ...
        {/* Content Area */}
        <div className={`p-6 lg:p-8 transition-all duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
          {/* Overview Tab */}
          {activeTab === 'overview' && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                {[
                  ...
                  <div 
                    key={stat.label}
                    className={`relative overflow-hidden p-6 bg-gradient-to-br ${stat.color} border border-white/10 rounded-2xl transition-all duration-500 hover:border-white/20`}
                  ...
                  {filteredCars.map((car, index) => (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row">
                        {/* Image */}
                        <div className="relative w-full sm:w-48 lg:w-64 aspect-[16/10] sm:aspect-auto sm:h-auto bg-white/5 flex-shrink-0">
                          {car.images && car.images.length > 0 ? (
                            <img 
                              src={car.images[car.showcaseImage || 0]} 
                              alt={car.name}
                        ...
                        <div className="flex-1 p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="flex-1">
                            ...
                            <p 
                              ...
                              style={{ fontFamily: 'Montserrat, sans-serif' }}
                            >
                              {car.year} • {car.brand} • {car.category} • {car.mileage.toLocaleString()} mi
                            </p>
                            <p 
                              className="text-xl font-bold"
                              style={{ fontFamily: 'Cera Pro, sans-serif' }}
                          ...
                          <div className="flex items-center gap-2 sm:gap-3">
                            ...
                            <button
                              ...
                              title={car.status === 'active' ? 'Set as Draft' : 'Publish'}
                            >
                              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
            ...
            <form onSubmit={handleSaveCar} className="p-6 space-y-8">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    >
                      {fuelTypes.map(fuel => (
                        <option key={fuel} value={fuel} className="bg-black">{fuel}</option>
                      ))}
                    </select>
                  </div>
                  <div>
              ...
              <div>
                ...
                <p 
                  ...
                  style={{ fontFamily: 'Montserrat, sans-serif' }}
                >
                  Upload vehicle images. Click the star icon to set the showcase image (banner).
                </p>
                    ...
                    {formData.images.map((img, index) => (
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-black/60 opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                          ...
                          >
                            <svg className="w-5 h-5" fill={formData.showcaseImage === index ? 'currentColor' : 'none'} stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <span style={{ fontFamily: 'Montserrat, sans-serif' }}>Add Feature</span>
                  </button>
                </div>
              </div>
      ...
      {notification && (
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span style={{ fontFamily: 'Montserrat, sans-serif' }}>{notification.message}</span>
          </div>
        </div>
      )}
    </div>
