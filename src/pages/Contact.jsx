...
export default function Contact() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[60vh] sm:min-h-screen flex flex-col justify-center pt-24 sm:pt-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 lg:px-24 w-full">
          ...
          <h1 
            ...
            style={{ fontFamily: 'Cera Pro, sans-serif', letterSpacing: '-0.03em', transitionDelay: '0.2s' }}
          >
          ...
          <p 
            ...
            style={{ fontFamily: 'Montserrat, sans-serif', transitionDelay: '0.3s' }}
          >
            Whether you're interested in our collection, need assistance, or simply want to discuss your automotive dreams, our team is ready to connect.
          </p>
        </div>
      </section>

      {/* Contact Information Grid */}
      <section ref={infoRef} className="relative py-24 lg:py-40 border-t border-white/10">
        {/* Background accent */}
      ...
      <section ref={formRef} className="relative py-24 lg:py-40 border-t border-white/10">
            ...
            >
              ...
              <div className="space-y-6 text-white/60" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                <p className="text-lg leading-relaxed">
                  Our team typically responds within 24 hours. Whether it's a question about inventory, scheduling a showroom visit, or discussing bespoke services, we're committed to providing exceptional service.
                </p>
                <p className="text-lg leading-relaxed">
                    ...
                    {submitted ? (
                      <>
                        <svg className="w-4 h-4 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2a10 10 0 1010 10H15" />
                        </svg>
                        Sending...
                      </>
                    ) : (
            ...
            {[
              {
                ...
                description: 'Experience our collection in person. Book an appointment for a personalized tour.'
              },
              {
                title: 'Test Drives',
                description: 'Feel the difference. Schedule a test drive with one of our vehicles today.'
              },
              {
                title: 'Consultations',
                description: 'Need expert advice? Our team is ready to help you find the perfect vehicle.'
              },
            ].map((item) => (
              <div 
                key={item.title}
          ...
          <div className="relative h-96 lg:h-96 bg-gradient-to-b from-white/5 to-transparent border border-white/10 flex items-center justify-center group overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
              <div className="absolute inset-0" style={{
                backgroundImage: 'linear-gradient(90deg, transparent 24%, rgba(255,255,255,0.05) 25%, rgba(255,255,255,0.05) 26%, transparent 27%, transparent 74%, rgba(255,255,255,0.05) 75%, rgba(255,255,255,0.05) 76%, transparent 77%, transparent), linear-gradient(0deg, transparent 24%, rgba(255,255,255,0.05) 25%, rgba(255,255,255,0.05) 26%, transparent 27%, transparent 74%, rgba(255,255,255,0.05) 75%, rgba(255,255,255,0.05) 76%, transparent 77%, transparent)',
